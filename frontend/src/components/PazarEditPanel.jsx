...
// Inline editor for one market: shows sales + costs like the PDF report, but the
// user can delete sales and add/delete costs. Numbers mirror generateReport().
export default function PazarEditPanel({ loc }) {
  ...
  return (
    <div className="mt-2 bg-white rounded-2xl shadow-sm border border-gray-100 p-4 space-y-5">
      ...
      <div>
        ...
        <form onSubmit={addExpense} className="flex gap-2 flex-wrap mb-2">
          <input
